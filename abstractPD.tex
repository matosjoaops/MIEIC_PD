...
To reach this goal, two tools created by former students to assist developers with these tasks, Hermit \cite{maduroAutomaticServiceContainerization2021} (focused on generation) and Dockerlive \cite{reisLiveDockerContainers2020} (focused on liveness and repair) will be improved. The upgrades performed will make it easier for developers to create Dockerfiles that follow best practices. Furthermore, a study will be conducted to evaluate the performance of Dockerlive and the way it enhances the development experience.
