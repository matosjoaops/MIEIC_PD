...
\begin{table}[H]
    ...
    \begin{tabular}{|p{0.25\textwidth}|c|p{0.2\textwidth}|p{0.2\textwidth}|}
        ...
        \hline Security Misconfigurations Detection and Repair in Dockerfile \cite{prinettoSecurityMisconfigurationsDetection} & ??? & ??? & ??? \\
        \hline Ten simple rules for writing Dockerfiles for reproducible data science \cite{nustTenSimpleRules2020} & ??? & ??? & ??? \\
        \hline
    \end{tabular} 
